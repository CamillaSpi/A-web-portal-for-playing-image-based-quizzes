...
For more details about the pages created, their description, their functionality, and their interconnections, please refer to the [report]("Relazione progetto TWS.pdf").
